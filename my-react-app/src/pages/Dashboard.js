...
const Dashboard = () => {
    const [userdata, setUserdata] = useState(ReactSession.get("USER"));
                ...
                < div className="row" >
                    ...
                    <div className="col-lg-6 mb-4">
                            ...
                            <div className="card-body">
                                <div className="text-center">
                                    <img className="img-fluid px-3 px-sm-4 mt-3 mb-4" style={{ width: "25rem" }}
                                        src={process.env.PUBLIC_URL + '/assets/img/undraw_posting_photo.svg'} alt="..." />
                                </div>
                        ...
                        <div className="card shadow mb-4">
                            ...
                            <div className="card-body">
                                <p>SB Admin 2 makes extensive use of Bootstrap 4 utility className in order to reduce
                                    CSS bloat and poor page performance. Custom CSS className are used to create
                                    custom components and custom utility className.</p>
                                <p className="mb-0">Before working with this theme, you should become familiar with the
                                    Bootstrap framework, especially the utility className.</p>
                            </div>
                        </div>
